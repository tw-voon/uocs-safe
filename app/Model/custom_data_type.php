...
class custom_data_type extends Model
{
    use Translatable;
    ...
    {
        return $this->hasMany(Voyager::modelClass('DataRow'), 'data_type_id')->orderBy('order');
    }

    public function browseRows()
    {
        return $this->rows()->join('report_type', 'typeID', 'data_rows.type_ID')->where('browse', 1);
    }
